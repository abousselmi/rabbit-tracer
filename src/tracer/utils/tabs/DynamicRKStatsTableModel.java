 ...
 */
public class DynamicRKStatsTableModel extends AbstractTableModel{

    ArrayList<Object[]> dataTable = new ArrayList<Object[]>();
    String[] header = new String [] {"id", "rk", "nbr(msg)", "%msg/rk", 
        "nbr(msg)/5s", "msg.rate/s", "msg.rate/m", "msg.rate/h",
        "total.data.quantity (KB)", "mean.data.quantity/msg (KB)"
    };
